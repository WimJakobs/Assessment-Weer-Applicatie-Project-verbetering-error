                        ...
                        if (response.ok===false) {
                            ...
                            if (response.status>=400 && response.status<=499) {
                                if (response.status===401) {
                                    reject("401: Authorisatieproces niet goed verlopen"); //return "401: Authorisatieproces niet goed verlopen";   throw new Error("401: Authorisatieproces niet goed verlopen");
                                }   else { 
